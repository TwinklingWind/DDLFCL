...
class Projector(nn.Module):
    def __init__(self, in_dim, out_dim, downsample=True):
        ...
        self.conv1 = conv(self.in_dim, self.in_dim)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv(self.in_dim, self.out_dim)
        self.conv3 = nn.Conv2d(self.out_dim, self.out_dim, kernel_size=1, stride=1)
